...
webhook = 'https://discordapp.com/api/webhooks/474275206081282048/N2c4Hvqxy_DW4DlBw3WBbvbcy0FPmWfzKCyr1KQubGPDDXieK_wKyfpUEBMqCCD5FVLY'
linklist = []
...
def monitor():
    ...
    proxy_picker = random.choice(proxy_list)
    proxy = {
        'http': 'http://' + proxy_picker,
        'https': 'http://' + proxy_picker
    }
